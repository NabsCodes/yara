  ...
  return (
    <section className="mx-auto max-w-[1240px] px-4">
      <motion.h1
        ...
        className="mx-auto mt-5 text-center text-[18px] font-bold leading-[56px] text-[#444444] dark:text-gray-200 sm:text-[20px] md:mt-10 md:text-[24px] lg:mt-0 lg:max-w-[500px] lg:text-[48px]"
      >
